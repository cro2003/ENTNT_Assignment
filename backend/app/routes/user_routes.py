...
def get_dashboard():
    ...
    for company in companies:
        ...
        # Fetch next scheduled communication
        periodicity = int(company.communication_periodicity.replace(" weeks", "").replace(" Weeks", "").strip()) if company.communication_periodicity else 2
...
def get_notifications():
    ...
    for company in companies:
        # Determine next scheduled communication
        periodicity = int(company.communication_periodicity.replace(" weeks", "").replace(" Weeks", "").strip()) if company.communication_periodicity else 2
